<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"./themes/default/member\index.html";i:1518236159;s:28:"./themes/default/layout.html";i:1518496023;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class="layui-this">企业人员管理</li>
            <li class=""><a href="<?php echo url('index/member/add'); ?>">添加</a></li>
            <li class=""><a href="<?php echo url('index/member/export'); ?>">导出</a></li>
            <li class=""><a href="<?php echo url('index/member/import'); ?>">导入</a></li>
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <form class="layui-form layui-form-pane" action="<?php echo url('index/member/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('index/member/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('index/member/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
